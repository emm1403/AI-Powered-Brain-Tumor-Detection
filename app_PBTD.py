...
st.set_page_config(page_title="Brain Tumor Detection: MRI Diagnosis and Patient Management", page_icon=None)
...
google_drive_id = "1T5jDAGnBaZzvmLquuZ78zs9uvg4Yl2b7"
...
recommendations_dict = {
    "Astrocytoma": (
        "Recommendation: Consider biopsy and histological grading. Astrocytomas vary in aggressiveness. "
        "Treatment may include surgery, radiotherapy, and chemotherapy."
    ),
    "Glioma": (
        "Recommendation: Refer to neuro-oncology for full workup. Treatment often includes surgery, "
        "radiotherapy, and temozolomide-based chemotherapy."
    ),
    "Meningioma": (
        "Recommendation: Evaluate lesion size and location. Asymptomatic meningiomas may be observed, "
        "while large/symptomatic ones often require surgery."
    ),
    "Neurocytoma": (
        "Recommendation: Central neurocytomas are rare and generally benign. Surgical resection is the treatment of choice. "
        "Follow-up imaging is required."
    ),
    "Pituitary Tumor": (
        "Recommendation: Conduct hormonal studies. Management depends on hormone production and size. "
        "Options include surgery or medical therapy."
    ),
    "Schwannoma": (
        "Recommendation: Often benign. Vestibular schwannomas (acoustic neuromas) may need surgical resection or radiosurgery "
        "depending on size/symptoms."
    ),
    "No Tumor": (
        "Recommendation: No signs of tumor detected. Consider differential diagnoses if symptoms persist."
    )
}
